...
public class ProductView extends JFrame {
    ...
    JLabel adaugaL = new JLabel("Adauga un produs nou");
    JLabel editeazaL = new JLabel("Editeaza un produs existent");
    JLabel stergeL = new JLabel("Sterge un produs");
    public JTable productsList = new JTable();
    public JTextField textField = new JTextField();
    public JComboBox dataCB = new JComboBox(new String[]{"Nume", "Cantitate", "Pret"});
    JLabel dataL = new JLabel("     ID                                       Nume                                  Cantitate                                   Pret");
    ...
    public ProductView() {
        ...
        adauga = new JButton(resize(new ImageIcon("C:\\Users\\this pc\\Desktop\\Facultate\\TP\\Laborator\\PT2021_30221_Georgian_Andreea_Assignment_3\\src\\main\\java\\presentation\\view\\new (1).png"), 40, 40));
        editeaza = new JButton(resize(new ImageIcon("C:\\Users\\this pc\\Desktop\\Facultate\\TP\\Laborator\\PT2021_30221_Georgian_Andreea_Assignment_3\\src\\main\\java\\presentation\\view\\edit.png"), 35, 35));
        sterge = new JButton(resize(new ImageIcon("C:\\Users\\this pc\\Desktop\\Facultate\\TP\\Laborator\\PT2021_30221_Georgian_Andreea_Assignment_3\\src\\main\\java\\presentation\\view\\out-of-stock.png"), 40, 40));
        ...
        productsList.setBounds(0, 220, 587, 350);
        textField.setBounds(350, 70, 200, 25);
        dataCB.setBounds(350, 100, 200, 30);
